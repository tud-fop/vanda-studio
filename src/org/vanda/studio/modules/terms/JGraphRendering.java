...
public class JGraphRendering {
	...
	public static void render(TermObject to, Graph g) {
	...
	protected static interface Renderer {
		...
		void render(TermObject to, Graph g);
	}
	...
	protected abstract static class DefaultRenderer implements Renderer {
		...
		@Override
		public void render(TermObject to, Graph g) {
			Object parent = g.getDefaultParent();
			g.getModel().beginUpdate();
			try
			{
				mxCell v = (mxCell) g.insertVertex(parent, null, to, to.getX(),
	...
	protected static class Graph extends mxGraph {
		...
		public String convertValueToString(Object cell) {
			...
			if (value instanceof TermObject)
				return ((TermObject)value).getName();
			else
				return "";
		}
